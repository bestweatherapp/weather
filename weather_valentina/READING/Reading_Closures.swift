//
//  Reading_Closures.swift
//  READING
//
//  Created by Валентина on 18.05.18.
...
class WeatherNetwork: NSObject {
    var city = "Moscow"
    func getWeather(complition: @escaping (_ datatModel: ForecastCity, [Double], [String]) -> ()){
        ...
        let task2 = URLSession.shared.dataTask(with: url2!)
        {
            ...
            do {
                ...
                complition(ResultForecastCity, allTempsdays, allDates)
            }
            catch let jsonError {
                print(jsonError)
            }
