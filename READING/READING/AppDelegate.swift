...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        scheduleNotification(at: createDate( hour: 17, minute: 18), body: "New notification", titles: "Hello, programmers!")
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        print("GoodBye") // Когда закрывается приложение
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
       ...
       //self.FirstView?.viewDidLoad()
        print ("Hello") // Когда открывается приложение
...
//уведомление о горзе на главный экран
