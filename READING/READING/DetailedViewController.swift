...
class DetailedViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       HumidityLabel.text! =  String(Int(round(dataFromFirst.AllForecastDay![indexFromFirst].avghumidity!)))+" %"
        ...
        UpMorning.image?.accessibilityIdentifier = "куртка_толстовка"
        case 0 ..< 10:
            UpMorning.image?.accessibilityIdentifier = "куртка_черная"
        case 10 ..< 15:
            UpMorning.image?.accessibilityIdentifier = "плащ_дождевик"
    
        case 15 ..< 20:
            UpMorning.image = UIImage(named : "лонгслив")
        case 20 ..< 25:
            UpMorning.image = UIImage(named : "рубашка")
        case 25 ..< 30:
            UpMorning.image?.accessibilityIdentifier = "поло"
        default :
            UpMorning.image?.accessibilityIdentifier = "футболка"
        }
